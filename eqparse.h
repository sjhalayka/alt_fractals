...
public:
	...
	float iterate_len(vector<vector_4> &escape_path_points, const quaternion &src_Z, const short unsigned int &max_iterations, const float &threshold);
	float iterate_disp(vector<vector_4> &escape_path_points, const quaternion &src_Z, const short unsigned int &max_iterations, const float &threshold);
	float iterate_mag(vector<vector_4> &escape_path_points, const quaternion &src_Z, const short unsigned int &max_iterations, const float &threshold);
