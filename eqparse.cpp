...
float quaternion_julia_set_equation_parser::iterate_len(vector<vector_4> &escape_path_points, const quaternion &src_Z, const short unsigned int &max_iterations, const float &threshold)
{
	Z = src_Z;
	...
	for (short unsigned int i = 0; i < max_iterations; i++)
	{
		...
		double d = 0, m = 0;
		get_path_properties(escape_path_points, l, d, m);
...
float quaternion_julia_set_equation_parser::iterate_disp(vector<vector_4> &escape_path_points, const quaternion &src_Z, const short unsigned int &max_iterations, const float &threshold)
{
	Z = src_Z;
...
float quaternion_julia_set_equation_parser::iterate_mag(vector<vector_4> &escape_path_points, const quaternion &src_Z, const short unsigned int &max_iterations, const float &threshold)
{
	Z = src_Z;
